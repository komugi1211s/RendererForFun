...
#define FP_MAX_IN_3(a, b, c) (FP_MAX(a, FP_MAX(b, c)))
#define FP_MIN_IN_3(a, b, c) (FP_MIN(a, FP_MIN(b, c)))
...
BB_fV3(fVector3 one, fVector3 two, fVector3 three) {
    ...
    box.min_v.x = FP_MIN_IN_3(one.x, two.x, three.x);
    box.min_v.y = FP_MIN_IN_3(one.y, two.y, three.y);
    box.min_v.z = FP_MIN_IN_3(one.z, two.z, three.z);

    box.max_v.x = FP_MAX_IN_3(one.x, two.x, three.x);
    box.max_v.y = FP_MAX_IN_3(one.y, two.y, three.y);
    box.max_v.z = FP_MAX_IN_3(one.z, two.z, three.z);
